...
public enum HelmLayout {
    ...
    public static let trainScrollBottomInsetWithNumpad: CGFloat = HelmSpacing.xl * 9 + HelmSpacing.md
    public static let numpadHeight: CGFloat = HelmSpacing.xl * 9 + HelmSpacing.md
