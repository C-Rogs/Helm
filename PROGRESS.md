...
| M5.3 Prescription + readiness gating + clamps | done | 2026-07-23 | c550aba | PlanKit prescription(for:givenReadiness:profile:history:), readiness gating, apply(adjustment:excluding:) with clamps. 7 new tests. |
