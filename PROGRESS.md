...
| M2.3 Readiness card re-skin + reveal | done | 2026-07-23 | b449139 | ArcGauge replaces M2.2 gauge; ArcRevealGauge + DailyRevealGate; once-per-day reveal + readinessReveal haptic via ReadinessRevealStore (HelmDay keyed). Contributors fade on reveal tail. Reduce Motion skips sweep. 2 DailyRevealGate unit tests.
