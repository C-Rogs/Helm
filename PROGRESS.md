...
| F-DT8.7 Arm emphasis weekly volume UX | done | 2026-07-29 | TBD | Reverted deterministic emphasis routing. Coach gets Training Plan Snapshot (verbatim emphasis + weekly ledger); engine keeps Push/Pull/Legs rotation only. |
| F-DT8.8 Coach recent workouts follow-up context | done | 2026-07-29 | 548ce3e | Follow-up chat turns include Recent Workouts block only; coach services pass full assembled context. |
